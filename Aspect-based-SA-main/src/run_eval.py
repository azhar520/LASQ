...
class Template:
    ...
    def forward(self, print_line=False):
        ...
        scores = []
        res = 'Item\tPrec.\tRec.\tF1\tRight\tPred\tGold\n'
        ...
        intra, inter = scores[8], scores[9]
        return micro_score, iden_score, res, intra, inter

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('-p', '--pred_file', default='data/save/pred_uz_test.json', type=str, required=False, help='pred file name with directory name')
    parser.add_argument('-g', '--gold_file', default='data/dataset/jsons_uz/test.json', type=str, required=False, help='gold file name with directory name')
